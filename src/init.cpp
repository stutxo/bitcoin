...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-transactionsonly", strprintf("Whether to reject blocks from network peers. RPC blocks are not affected. (default: %u)", DEFAULT_TRANSACTIONSONLY), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
